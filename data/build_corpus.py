...
pages on *.internal.example / *.corp.example domains are added for the domain-block
attack test. Run locally when the corpus changes:
...
from scenarios import CANARIES, CLASS_DOMAINS, PAGE_LAYOUTS
